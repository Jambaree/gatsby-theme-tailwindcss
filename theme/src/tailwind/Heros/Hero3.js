...
export const Hero3 = (props) => {
  const customFeatures = props.features
  const customCTA = props.callsToAction
  const customResources = props.resources
  const customRecentPosts = props.recentPosts
  ...
  const recentPosts = !customRecentPosts
    ? [
